        ...
        <div className="contact-inner">
            <div className="contact-upper">
                <div className="contact-upper-left">
                    ...
                    <div className="contact-info">
                        ...
                        <div className="contact-info-desc">For Support with yur bookings and other queries </div>
                    </div>
                </div>
                ...
                <div className="contact-img"><BiNews/></div>
                    <div className="contact-info">
                        ...
                        <div className="contact-info-desc">For press and media related queries please reach out to us</div>
                    </div>
                </div>
            </div>
            ...
            <div className="contact-lower-left">
                    ...
                    <div className="contact-info">
                        ...
                        <div className="contact-info-desc">If you have security concerns, please report your issue</div>
                    </div>
                </div>
                ...
                <div className="contact-img"><GiCartwheel/></div>
                    <div className="contact-info">
                        ...
                        <div className="contact-info-desc">if you are a driver or a fleet manager and want to attach your vehicle</div>
                    </div>
                </div>
            </div>
        </div>
