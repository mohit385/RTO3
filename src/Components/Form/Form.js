...
const Form = () => {
  ...
  return (
    <div className="form-container" id='form'>
      ...
      <div className="form-inner">
        <div className="form-top fl">
          <div className="form-pickup fi">
            ...
            <input type="text" placeholder='First Name' name="pickup" autoComplete='off'
            onChange={(event)=>{setPickUp(event.target.value);}}
          /></div>
          <div className="form-drop fi"><input type="text" placeholder='Last Name' name="drop"  autoComplete='off'
          onChange={(event)=>{setDrop(event.target.value);}}
          /></div>
          <div className="form-passenger fi"><MdOutlinePeopleAlt/><input type="text" placeholder="Age"  name="passenger"  autoComplete='off'
      ...
      <div  className="form-book fi"  onClick={()=>setBook(true)}  >Licence Appointment</div>
    </div>
  )
}
